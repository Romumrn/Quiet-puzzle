...
export const REALMS = [
  {
    id: 0,
    nom: { fr: 'Peaceful Sakura', en: 'Peaceful Sakura', es: 'Peaceful Sakura', it: 'Peaceful Sakura', zh: 'Peaceful Sakura' },
  ...
  {
    id: 1,
    nom: { fr: 'Wisteria Veil', en: 'Wisteria Veil', es: 'Wisteria Veil', it: 'Wisteria Veil', zh: 'Wisteria Veil' },
  ...
  {
    id: 2,
    nom: { fr: 'Blue Lys', en: 'Blue Lys', es: 'Blue Lys', it: 'Blue Lys', zh: 'Blue Lys' },
  ...
  {
    id: 3,
    nom: { fr: 'Forget Me Not', en: 'Forget Me Not', es: 'Forget Me Not', it: 'Forget Me Not', zh: 'Forget Me Not' },
  ...
  {
    id: 4,
    nom: { fr: 'Eucalyptus Calm', en: 'Eucalyptus Calm', es: 'Eucalyptus Calm', it: 'Eucalyptus Calm', zh: 'Eucalyptus Calm' },
  ...
  {
    id: 5,
    nom: { fr: 'Mimosa Sun', en: 'Mimosa Sun', es: 'Mimosa Sun', it: 'Mimosa Sun', zh: 'Mimosa Sun' },
  ...
  {
    id: 6,
    nom: { fr: 'Golden Ginkgo', en: 'Golden Ginkgo', es: 'Golden Ginkgo', it: 'Golden Ginkgo', zh: 'Golden Ginkgo' },
  ...
  {
    id: 7,
    nom: { fr: 'Autumn Elm', en: 'Autumn Elm', es: 'Autumn Elm', it: 'Autumn Elm', zh: 'Autumn Elm' },
  ...
  {
    id: 8,
    nom: { fr: 'Winter Maple', en: 'Winter Maple', es: 'Winter Maple', it: 'Winter Maple', zh: 'Winter Maple' },
  ...
  {
    id: 9,
    nom: { fr: 'Apple Blossom', en: 'Apple Blossom', es: 'Apple Blossom', it: 'Apple Blossom', zh: 'Apple Blossom' },
  ...
  {
    id: 10,
    nom: { fr: 'Quiet Camellia', en: 'Quiet Camellia', es: 'Quiet Camellia', it: 'Quiet Camellia', zh: 'Quiet Camellia' },
  ...
  {
    id: 11,
    nom: { fr: 'Lilac Drift', en: 'Lilac Drift', es: 'Lilac Drift', it: 'Lilac Drift', zh: 'Lilac Drift' },
  ...
  {
    id: 12,
    nom: { fr: 'Cornflower Blue', en: 'Cornflower Blue', es: 'Cornflower Blue', it: 'Cornflower Blue', zh: 'Cornflower Blue' },
  ...
  {
    id: 13,
    nom: { fr: 'Morning Glory', en: 'Morning Glory', es: 'Morning Glory', it: 'Morning Glory', zh: 'Morning Glory' },
  ...
  {
    id: 14,
    nom: { fr: 'Sage Fern', en: 'Sage Fern', es: 'Sage Fern', it: 'Sage Fern', zh: 'Sage Fern' },
  ...
  {
    id: 15,
    nom: { fr: 'Honey Acacia', en: 'Honey Acacia', es: 'Honey Acacia', it: 'Honey Acacia', zh: 'Honey Acacia' },
  ...
  {
    id: 16,
    nom: { fr: 'Amber Birch', en: 'Amber Birch', es: 'Amber Birch', it: 'Amber Birch', zh: 'Amber Birch' },
  ...
  {
    id: 17,
    nom: { fr: 'Apricot Branch', en: 'Apricot Branch', es: 'Apricot Branch', it: 'Apricot Branch', zh: 'Apricot Branch' },
  ...
  {
    id: 18,
    nom: { fr: 'Red Berry', en: 'Red Berry', es: 'Red Berry', it: 'Red Berry', zh: 'Red Berry' },
  ...
  {
    id: 19,
    nom: { fr: 'Snow Willow', en: 'Snow Willow', es: 'Snow Willow', it: 'Snow Willow', zh: 'Snow Willow' },
  ...
  {
    id: 20,
    nom: { fr: 'Blush Plum', en: 'Blush Plum', es: 'Blush Plum', it: 'Blush Plum', zh: 'Blush Plum' },
    difficulte: { fr: 'cloisonné', en: 'partitioned', es: 'compartimentado', it: 'compartimentato', zh: '分隔' },
    teinte: 345,
    palette: ['#c98fa4', '#849dc6', '#83bfa4', '#c8b47c', '#9c8dc4', '#c99a8a'],
    nouveaute: null,
    apporte: { fr: 'Des murs partout : l’espace se referme', en: 'Walls everywhere: the space closes in', es: 'Muros por doquier: el espacio se cierra', it: 'Muri ovunque: lo spazio si chiude', zh: '四处是墙，空间收紧' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 21,
    nom: { fr: 'Lavender Field', en: 'Lavender Field', es: 'Lavender Field', it: 'Lavender Field', zh: 'Lavender Field' },
    difficulte: { fr: 'enchaîné', en: 'chained', es: 'encadenado', it: 'concatenato', zh: '环环相扣' },
    teinte: 275,
    palette: ['#c58ba0', '#7fa3cb', '#7cc0a8', '#c6b17e', '#9689c8', '#c69688'],
    nouveaute: null,
    apporte: { fr: 'Des verrous qui s’ouvrent l’un après l’autre', en: 'Locks that open one after another', es: 'Cerrojos que se abren uno tras otro', it: 'Serrature che si aprono una dopo l’altra', zh: '锁需依次开启' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 22,
    nom: { fr: 'Blue Hydrangea', en: 'Blue Hydrangea', es: 'Blue Hydrangea', it: 'Blue Hydrangea', zh: 'Blue Hydrangea' },
    difficulte: { fr: 'rigide', en: 'rigid', es: 'rígido', it: 'rigido', zh: '僵硬' },
    teinte: 225,
    palette: ['#d2947e', '#86aec2', '#93c191', '#ccb377', '#a292c0', '#cc9b7e'],
    nouveaute: null,
    apporte: { fr: 'Presque rien ne circule librement', en: 'Almost nothing moves freely', es: 'Casi nada circula libremente', it: 'Quasi nulla si muove liberamente', zh: '几乎无一可自由移动' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 23,
    nom: { fr: 'Winter Frost', en: 'Winter Frost', es: 'Winter Frost', it: 'Winter Frost', zh: 'Winter Frost' },
    difficulte: { fr: 'pesant', en: 'weighty', es: 'pesado', it: 'pesante', zh: '沉重' },
    teinte: 200,
    palette: ['#c08bb0', '#8296cc', '#7fbdac', '#c4ad7d', '#9887c9', '#c1948f'],
    nouveaute: null,
    apporte: { fr: 'Les encombrants saturent les portes', en: 'Heavy blocks saturate the gates', es: 'Los voluminosos saturan las puertas', it: 'Gli ingombranti saturano le porte', zh: '笨重方块塞满门口' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 24,
    nom: { fr: 'Bamboo Breeze', en: 'Bamboo Breeze', es: 'Bamboo Breeze', it: 'Bamboo Breeze', zh: 'Bamboo Breeze' },
    difficulte: { fr: 'trouble', en: 'murky', es: 'turbio', it: 'torbido', zh: '混沌' },
    teinte: 145,
    palette: ['#c68fa2', '#84a8c9', '#88c495', '#c9b57a', '#9c8ec6', '#c59a85'],
    nouveaute: null,
    apporte: { fr: 'Presque chaque porte sert deux couleurs', en: 'Nearly every gate serves two colours', es: 'Casi cada puerta sirve a dos colores', it: 'Quasi ogni porta serve due colori', zh: '几乎每道门都通两色' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 25,
    nom: { fr: 'Yellow Broom', en: 'Yellow Broom', es: 'Yellow Broom', it: 'Yellow Broom', zh: 'Yellow Broom' },
    difficulte: { fr: 'inextricable', en: 'tangled', es: 'intrincado', it: 'intricato', zh: '纠缠难解' },
    teinte: 55,
    palette: ['#bd88a4', '#7d95c6', '#79bba6', '#c0aa78', '#9184c4', '#bf9086'],
    nouveaute: null,
    apporte: { fr: 'De grosses pièces dans des couloirs étroits', en: 'Big pieces in narrow corridors', es: 'Piezas grandes en pasillos estrechos', it: 'Pezzi grandi in corridoi stretti', zh: '大块方块，窄小通道' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 26,
    nom: { fr: 'Wheat Field', en: 'Wheat Field', es: 'Wheat Field', it: 'Wheat Field', zh: 'Wheat Field' },
    difficulte: { fr: 'implacable', en: 'relentless', es: 'implacable', it: 'implacabile', zh: '毫不留情' },
    teinte: 40,
    palette: ['#c4877f', '#83a3c0', '#84bd93', '#c3ae76', '#9787c2', '#c3927c'],
    nouveaute: null,
    apporte: { fr: 'Tout se déplace sur un rail ou une flèche', en: 'Everything runs on a rail or an arrow', es: 'Todo se mueve sobre un raíl o una flecha', it: 'Tutto scorre su un binario o una freccia', zh: '一切皆循轨与箭' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 27,
    nom: { fr: 'Copper Beech', en: 'Copper Beech', es: 'Copper Beech', it: 'Copper Beech', zh: 'Copper Beech' },
    difficulte: { fr: 'compté', en: 'counted', es: 'contado', it: 'contato', zh: '分秒必争' },
    teinte: 25,
    palette: ['#bd8697', '#7a9cc4', '#77bba2', '#bfa974', '#8f81be', '#bd8f81'],
    nouveaute: null,
    apporte: { fr: 'Chaque porte est comptée à la case près', en: 'Every gate counted to the cell', es: 'Cada puerta contada al detalle', it: 'Ogni porta contata al millimetro', zh: '每道门的容量精确到格' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 28,
    nom: { fr: 'Crimson Vine', en: 'Crimson Vine', es: 'Crimson Vine', it: 'Crimson Vine', zh: 'Crimson Vine' },
    difficulte: { fr: 'sans complaisance', en: 'unforgiving', es: 'sin concesiones', it: 'senza sconti', zh: '绝不宽容' },
    teinte: 5,
    palette: ['#b9839f', '#7692c0', '#73b79e', '#bba572', '#8b7dba', '#b98b7d'],
    nouveaute: null,
    apporte: { fr: 'Tout le jeu à la fois, sans rien pour souffler', en: 'The whole game at once, no let-up', es: 'Todo el juego a la vez, sin respiro', it: 'Tutto il gioco insieme, senza tregua', zh: '全部机制齐上，毫无喘息' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
  ...
  {
    id: 29,
    nom: { fr: 'Silver Mist', en: 'Silver Mist', es: 'Silver Mist', it: 'Silver Mist', zh: 'Silver Mist' },
    difficulte: { fr: 'vertigineux', en: 'dizzying', es: 'vertiginoso', it: 'vertiginoso', zh: '令人眩晕' },
    teinte: 30,
    palette: ['#b57f9b', '#728ebc', '#6fb39a', '#b7a16e', '#8779b6', '#b58779'],
    nouveaute: null,
    apporte: { fr: 'Les grilles les plus retorses du jeu', en: 'The most devious grids in the game', es: 'Las cuadrículas más retorcidas del juego', it: 'Le griglie più insidiose del gioco', zh: '全游戏最刁钻的棋盘' },
    W: 9, H: 11, colorCount: 6, gateCount: 8,
...
function curve(n) {
  ...
  return {
    ...
    exigeant: R.exigeant === true || R.exigenceCible > 0,
    /**
     * États explorés par bloc à atteindre avant de s'arrêter de chercher.
     *
     * C'est le SEUL levier qui passe encore à l'échelle. Grille, couleurs,
     * portes, types de blocs : tout est à son maximum jouable, et empiler des
     * quantités ne ferait que remplir. Une cible qui monte d'un monde à l'autre
     * demande, elle, des grilles où l'on se trompe de plus en plus souvent
     * avant de trouver — et c'est exactement ce qu'on entend par « réfléchir ».
     */
    exigenceCible: R.exigenceCible ?? 12,
    jokers: R.jokers,
    blockCount,
    /**
 ...
 */
/**
 * Budget de la mesure d'exigence, calé sur ce qu'on cherche.
 *
 * Il était fixé à trente mille états — quinze fois plus que la cible la plus
 * haute (soixante-quatre états par bloc sur une trentaine de blocs). Les
 * grilles les plus retorses, justement celles qu'on veut retenir, coûtaient
 * donc le plus cher à mesurer, pour un chiffre dont seule l'ampleur importait.
 * Une marge de moitié au-dessus de la cible suffit à départager, et la
 * fabrication passe de dix-sept minutes à moins de cinq.
 */
const budgetExigence = (cible, blocs) => Math.max(1500, Math.round(cible * blocs * 1.5));

function exigenceDe(g, budget = 30000) {
  const board = new Board({
    width: g.W, height: g.H, gates: g.gates, blocks: g.blocks,
    moveLimit: 9999, timeLimit: 9999, solution: [],
  });
  const r = resoudre(board, budget);
...
function build(n) {
   ...
   */
  const finalistes = [];
  // Plus la cible est haute, plus il faut de candidates à départager : sur les
  ...
  if (p.exigeant && finalistes.length) {
    ...
    for (const c of finalistes) {
      const etats = exigenceDe(c, budgetExigence(p.exigenceCible, c.blocks.length));
      if (etats > exigenceMax) { exigenceMax = etats; retenue = c; }
      if (etats >= c.blocks.length * p.exigenceCible) break;
    }
    meilleure = retenue;
