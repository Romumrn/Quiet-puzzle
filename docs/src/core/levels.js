...
export const REALMS = [
  ...
  {
    id: 20,
    nom: { fr: 'Le Cloître', en: 'The Cloister', es: 'El Claustro', it: 'Il Chiostro', zh: '回廊' },
  ...
  {
    id: 21,
    nom: { fr: 'La Chaîne', en: 'The Chain', es: 'La Cadena', it: 'La Catena', zh: '连锁' },
  ...
  {
    id: 22,
    nom: { fr: 'Le Carrousel', en: 'The Carousel', es: 'El Carrusel', it: 'La Giostra', zh: '旋转木马' },
  ...
  {
    id: 23,
    nom: { fr: 'La Balance', en: 'The Scales', es: 'La Balanza', it: 'La Bilancia', zh: '天平' },
  ...
  {
    id: 24,
    nom: { fr: 'Le Prisme', en: 'The Prism', es: 'El Prisma', it: 'Il Prisma', zh: '棱镜' },
  ...
  {
    id: 25,
    nom: { fr: 'Le Labyrinthe', en: 'The Labyrinth', es: 'El Laberinto', it: 'Il Labirinto', zh: '迷宫' },
  ...
  {
    id: 26,
    nom: { fr: 'Le Métronome', en: 'The Metronome', es: 'El Metrónomo', it: 'Il Metronomo', zh: '节拍器' },
  ...
  {
    id: 27,
    nom: { fr: 'La Clepsydre', en: 'The Water Clock', es: 'La Clepsidra', it: 'La Clessidra', zh: '水钟' },
  ...
  {
    id: 28,
    nom: { fr: 'L’Épreuve', en: 'The Trial', es: 'La Prueba', it: 'La Prova', zh: '考验' },
  ...
  {
    id: 29,
    nom: { fr: 'Le Vertige', en: 'The Vertigo', es: 'El Vértigo', it: 'La Vertigine', zh: '眩晕' },
