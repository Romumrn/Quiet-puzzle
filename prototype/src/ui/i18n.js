...
const STRINGS = {
  fr: {
    ...
    'lives.pause.title': 'Petite pause', 'lives.pause.sub': 'Vos cœurs se reposent. Le prochain revient dans',
    'lives.pause.ad': '▶ Regarder une pub · +1 ♥', 'lives.pause.later': 'Revenir plus tard',
    'lives.gained': '+1 ♥ — bonne partie !', 'lives.aria': '{n} vies',
    'lives.title': 'Vos cœurs', 'lives.next': 'Prochain cœur dans', 'lives.full': 'Tous vos cœurs sont là. Bonne partie !', 'lives.buy': '+1 ♥ pour',
    ...
    'editor.grid': 'Grille', 'editor.width': 'Largeur', 'editor.height': 'Hauteur',
    ...
    'result.streak': '🔥 {n} niveaux d’affilée',
    'realm.done': 'Monde terminé !', 'realm.next.label': 'À venir',
    'realm.continue': 'Continuer',
    ...
    'toast.hint.park': 'Ce bloc ne sort pas : écartez-le pour libérer le passage',
  ...
  en: {
    ...
    'user.night': 'Night mode',
    'streak.badge': '{n} d', 'streak.next': '{n} more days for {what}',
    'streak.reward.coins': '{n} shards',
    ...
    'lives.pause.title': 'Short break', 'lives.pause.sub': 'Your hearts are resting. The next one is back in',
    'lives.pause.ad': '▶ Watch an ad · +1 ♥', 'lives.pause.later': 'Come back later',
    'lives.gained': '+1 ♥ — enjoy!', 'lives.aria': '{n} lives',
    'lives.title': 'Your hearts', 'lives.next': 'Next heart in', 'lives.full': 'All your hearts are here. Enjoy!', 'lives.buy': '+1 ♥ for',
    ...
    'editor.grid': 'Grid', 'editor.width': 'Width', 'editor.height': 'Height',
    ...
    'result.streak': '🔥 {n} levels in a row',
    'realm.done': 'World complete!', 'realm.next.label': 'Coming up',
    'realm.continue': 'Continue',
    ...
    'toast.hint.park': 'This block does not leave: move it aside to clear the way',
  ...
  es: {
    ...
    'user.night': 'Modo noche',
    'streak.badge': '{n} d', 'streak.next': '{n} días más para {what}',
    'streak.reward.coins': '{n} fragmentos',
    ...
    'lives.pause.title': 'Pequeña pausa', 'lives.pause.sub': 'Tus corazones descansan. El próximo vuelve en',
    'lives.pause.ad': '▶ Ver un anuncio · +1 ♥', 'lives.pause.later': 'Volver más tarde',
    'lives.gained': '+1 ♥ — ¡a jugar!', 'lives.aria': '{n} vidas',
    'lives.title': 'Tus corazones', 'lives.next': 'Próximo corazón en', 'lives.full': 'Tienes todos tus corazones. ¡A jugar!', 'lives.buy': '+1 ♥ por',
    ...
    'editor.grid': 'Cuadrícula', 'editor.width': 'Ancho', 'editor.height': 'Alto',
    ...
    'result.streak': '🔥 {n} niveles seguidos',
    'realm.done': '¡Mundo completado!', 'realm.next.label': 'Próximamente',
    'realm.continue': 'Continuar',
    ...
    'toast.hint.park': 'Este bloque no sale: apártalo para liberar el paso',
  ...
  it: {
    ...
    'user.night': 'Modalità notte',
    'streak.badge': '{n} g', 'streak.next': 'Ancora {n} g per {what}',
    'streak.reward.coins': '{n} schegge',
    ...
    'lives.pause.title': 'Piccola pausa', 'lives.pause.sub': 'I tuoi cuori riposano. Il prossimo torna tra',
    'lives.pause.ad': '▶ Guarda un annuncio · +1 ♥', 'lives.pause.later': 'Torna più tardi',
    'lives.gained': '+1 ♥ — buon gioco!', 'lives.aria': '{n} vite',
    'lives.title': 'I tuoi cuori', 'lives.next': 'Prossimo cuore tra', 'lives.full': 'Hai tutti i tuoi cuori. Buon gioco!', 'lives.buy': '+1 ♥ per',
    ...
    'editor.grid': 'Griglia', 'editor.width': 'Larghezza', 'editor.height': 'Altezza',
    ...
    'result.streak': '🔥 {n} livelli di fila',
    'realm.done': 'Mondo completato!', 'realm.next.label': 'In arrivo',
    'realm.continue': 'Continua',
    ...
    'toast.hint.park': 'Questo blocco non esce: spostalo per liberare il passaggio',
  ...
  zh: {
    ...
    'lives.pause.title': '休息一下', 'lives.pause.sub': '你的爱心正在休息，下一颗将在以下时间后恢复',
    'lives.pause.ad': '▶ 观看广告 · +1 ♥', 'lives.pause.later': '稍后再来',
    'lives.gained': '+1 ♥ — 玩得开心！', 'lives.aria': '{n} 条生命',
    'lives.title': '你的爱心', 'lives.next': '下一颗爱心将在', 'lives.full': '爱心已满，玩得开心！', 'lives.buy': '+1 ♥，花费',
    ...
    'editor.grid': '网格', 'editor.width': '宽度', 'editor.height': '高度',
    ...
    'result.reward': '+{n} 碎片',
    'result.streak': '🔥 连续通关 {n} 关',
    'realm.done': '世界通关！', 'realm.next.label': '即将开启',
    'realm.continue': '继续',
    ...
    'toast.hint.park': '这个方块不出门：把它挪开，让路给别的方块',
